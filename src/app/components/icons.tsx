// Heroicons SVGs as React components (MIT License)
// Only the icons needed for this project
...
export const MenuIcon = ({ className = '' }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M3.5 6h17M3.5 12h17M3.5 18h17" />
  </svg>
);
...
export const MonitorIcon = ({ className = '' }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 20h8m-6-4v4m4-4v4" />
  </svg>
);
